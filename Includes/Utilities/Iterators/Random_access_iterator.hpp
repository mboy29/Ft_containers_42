	...
	template <class Iterator>
		class random_access_iterator : public iterator<random_access_iterator_tag, Iterator> {
			...
			public:
				...
				random_access_iterator	operator+(difference_type n) const { //  Operator+ -> a + n
					return (this->_ptr + n);
				}

				template<class It> //  Operator+ -> n + a
					friend random_access_iterator<It>	operator+(typename random_access_iterator<It>::difference_type n, random_access_iterator<It> const &rhs);
