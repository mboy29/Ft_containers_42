...
void	testingMapModifiers(map<int, std::string> *test) {
	map<int, std::string>::iterator it = test->begin();

	test->insert(pair<int, std::string>(10, "Ten"));
  	test->insert (it, pair<int, std::string>(8,"Eight"));  // max efficiency inserting
  	test->insert (it, pair<int, std::string>(-1, "Minus One")); 
